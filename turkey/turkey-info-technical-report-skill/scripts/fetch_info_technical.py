...
def fetch_info_technical(
    ...
    *,
    ...
    if use_project_fetcher and workdir:
        ...
        project_result = fetch_info_via_project("info-technical", target_date, workdir)
...
if __name__ == "__main__":
    ...
    cache = Path(sys.argv[2]) if len(sys.argv) > 2 else Path(".cache/turkey-info-technical-report")
    r = fetch_info_technical(target, cache)
