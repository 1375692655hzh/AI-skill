...
**北京时间（仅交易日）主跑 00:05～00:15**（TR ≈ 19:05～19:15）。  
备选：23:55 跑一轮，若 `list_absent` / 无文 / `gen_failed` 则 **00:15 重试 1 次**。
...
```
output/{日期}_close_report_zh.md          # 完整版
output/{日期}_close_report_brief_zh.md    # 简报版
```
...
A: 可能还没收盘或列表未上架，建议主跑放到 00:05～00:15；23:55 失败则 00:15 再试一次。
