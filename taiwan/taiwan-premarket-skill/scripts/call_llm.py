#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""OpenAI-compatible LLM caller (same pattern as turkey-*-skill)."""
...
def call_llm(
    ...
    max_tokens: int = 8000,
    system: str = "You are a Taiwan equity institutional research analyst writing Chinese market notes. Numbers must come only from the provided data brief.",
    timeout: int = 300,
) -> str:
