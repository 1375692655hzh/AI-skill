...
def call_llm(
    ...
    max_tokens: int = 2500,
    system_message: str = "You are a Turkish market analyst writing a Chinese technical analysis report with markdown tables.",
) -> str:
    api_key = _resolve_api_key(api_key_or_env)
    if not api_key:
